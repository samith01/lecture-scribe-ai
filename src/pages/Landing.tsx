...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            Stop Typing.
            <span
              className="block text-blue-600 mt-2 animate-fade-in"
          ...
          <p
            className="text-xl sm:text-2xl text-slate-600 mb-8 leading-relaxed animate-fade-in"
          ...
          <div
            className="flex flex-col sm:flex-row gap-3 justify-center items-center mb-6 animate-fade-in"
          ...
          <div
            className="flex items-center justify-center gap-6 text-sm text-slate-600 animate-fade-in"
      ...
      <div className="flex items-center justify-center gap-6 text-sm text-slate-600 animate-fade-in mt-2">
        <a
          className="hidden sm:inline-block"
          href="https://www.producthunt.com/products/notesbyai?embed=true&utm_source=badge-featured&utm_medium=badge&utm_source=badge-notesbyai"
          target="_blank"
        >
          <img
        ...
        <a
          href="https://startupfa.me/s/notesbyai?utm_source=notesbyai.vercel.app"
          target="_blank"
          className="hidden sm:inline-block"
        ...
        >
          <img
            ...
            alt="NotesByAI - Featured on Startup Fame"
            width="224"
            height="36"
          />
        </a>
      ...
      <section
        className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 animate-fade-in"
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-slate-600">
            Real-time, perfectly structured notes generated as your professor
            speaks
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div
            className="bg-white p-8 rounded-xl border-2 border-slate-200 hover:border-blue-300 transition-all hover-scale animate-fade-in"
            style={{ animationDelay: "100ms" }}
          >
            ...
            <p className="text-slate-600 leading-relaxed">
              No need to write. Just listen, understand, and engage with your
              professor while AI captures everything.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-slate-600 leading-relaxed">
              Watch as your lecture transforms into organized, study-ready notes
              with sections, bullets, and key terms highlighted.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-slate-600 leading-relaxed">
              Download as PDF or Markdown. Review anytime. Perfect for studying,
              sharing, or uploading to your note system.
            </p>
          </div>
        </div>

        <div
          className="mt-12 bg-slate-50 rounded-xl p-8 border animate-fade-in"
          style={{ animationDelay: "400ms" }}
        >
          <h3 className="text-xl font-semibold mb-4">Works Everywhere</h3>
          <p className="text-slate-600 mb-4">
            In-person lectures, online classes, recorded sessions—just hit
            record and let AI do the work.
          </p>
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-700 text-white py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p
            className="text-xl mb-4 text-blue-100 animate-fade-in"
            style={{ animationDelay: "200ms" }}
          >
            One-time payment of{" "}
            <span className="font-bold text-white text-3xl">$4.99</span> for
            beta access
          </p>

          <p
            className="text-lg mb-8 text-blue-100 animate-fade-in"
            style={{ animationDelay: "300ms" }}
          >
            No free trial—watch the demo, then decide. Beta users get priority
            support and special Discord perks.
          </p>

          <div
            className="bg-white/10 backdrop-blur-sm rounded-xl p-8 mb-8 border border-white/20 animate-fade-in"
            style={{ animationDelay: "400ms" }}
          >
          ...
          <div
            className="bg-orange-500/20 border border-orange-300/50 rounded-lg p-4 max-w-md mx-auto animate-scale-in"
